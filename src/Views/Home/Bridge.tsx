    ...
    try {
      if (nft.collectionId !== null) {
        ...
        const callingAccount =
          typeof account === typeof "" ? account : account.address;
        setLoadingState(true);
        const result = await polkadotToEthereum(
          nft,
          callingAccount,
          targetAddress
        );
        ...
        const callingAccount =
          typeof account === typeof "" ? account : account.address;
        setLoadingState(true);
        const result = await ethereumToPolkadot(
          nft,
          callingAccount,
          targetAddress
        );
    ...
    <div>
      <div>
        <div>
          ...
          />
          {sourceChain !== "" && (
            <ConnectWallet type={sourceChain} setAddress={setAccount} />
          )}
        </div>
        <div>
